...
# Add these lines to your ML training script after X is finalized:
model_features_list = X.columns.tolist()
joblib.dump(model_features_list, 'model_features_order.joblib')
...
# This is needed for the selectbox options.
try:
